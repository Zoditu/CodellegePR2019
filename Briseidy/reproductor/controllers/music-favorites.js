...
class MusicFavorites extends EndpointBase
{
    ...
    {
        //lastIndex = id;
        var id = owner.favorites[i]; // contiene el primer id de la favorita 
    ...
    //$and: [{id...}, {$or }]
    /*if(lastIndex === owner.favorites.length-1) // si el ultimo indice 
        lastIndex = owner.favorites.length; // a lastindex asignale el tamaño del arreglo */
